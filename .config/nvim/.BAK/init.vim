...
nnoremap <Leader><left> :25winc <<cr>
nnoremap <Leader><right> :25winc ><cr>
...
map <leader>f :Telescope diagnostics<cr>
...
let g:ale_python_flake8_options = '--max-line-length=140 --ignore=E501,E266,W503,E402 --extend-ignore=W503'
"let g:ale_python_pyright_options = '--max-line-length=140 --ignore=E501,E266,W503,E402 --extend-ignore=W503'
"
